...
@section('content')
<form action="{{ route('admin.order.update', $id) }}" class="table table-bordered table-hover table-striped m-5 pl-5" method="post">
    @csrf
    @method('put')
    ...
    <div class="mb-2">
        <a href="{{ route('admin.order.index',$order->id) }}" class="btn btn-secondary">Trở về</a>
